...
#         request.cls.login_page = LoginPage(browser_chrom)
#         request.cls.base_page = BasePage(browser_chrom)
#         request.cls.forgot_password_page = ForgotPasswordPage(browser_chrom)
#         request.cls.reset_password_page = ResetPasswordPage(browser_chrom)
#         request.cls.designer_page = DesignerPage(browser_chrom)
#         request.cls.personal_account = PersonalAccount(browser_chrom)
#         request.cls.history_order = HistoryOrderPage(browser_chrom)
#         request.cls.order_feed_page = OrderFeedPage(browser_chrom)
